    ...
    def __init__(self, directory, transform=None, num_samples_per_class=None):
        ...
        for file_path in all_files:
            with open(file_path, 'rb') as f:
                ...
                if gleason_score == '0':  # Klasa zdrowa
...
def train_model(model, train_loader, val_loader, criterion, optimizer, scheduler, device, path, num_epochs=30):
    model.to(device)
...
PATH = '/mnt/ip105/dpietrzak/panda/model/resnet18_hel_vs_cancer_ADAMW.pth'
