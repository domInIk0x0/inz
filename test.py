'''
Skrypt znajduje sie pod adresem /mnt/data/dpietrzak/resnet18_SGD_5classes.py  na serwerze z gpu

/mnt/ip105/dpietrzak/panda/clear_paths.pkl - Tutaj znajduje sie lista sciezek do kafelkow zdjec , sciezki w tej liscie
odnoszą sie do folderu /mnt/ip105/dpietrzak/panda/normalized_tiles/ - w tym folderze znajduja sie wszystkie kafelki . 

Tez są pkl, pojedyncze kafel ma nastepujaca struktue 
pickle.dump({
...
uzywane do treningu tylko data['patch'] (tablica numpy 256x256x3) i
data['gleason'] string w postaci '3+3' '4+4' lub '5+5' 
...
# Obliczanie wagi dla funkcji straty
...
# SCIEZKA POD JAKA MAJA ZOSTAC ZAPISANE PARAMETRY WYTRENOWANEGO MODELU
